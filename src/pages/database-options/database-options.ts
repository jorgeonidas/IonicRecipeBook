...
//pagina Popover, esta sera implementada por medio de un PopoverControler
@Component({
...
export class DatabaseOptionsPage{
    ...
    onAction(action: string){
        this.viewCtrl.dismiss({action: action}); //cierra el PopOver enviando el string denotando la accion
    }
}